"use strict";
cc._RF.push(module, 'a102cJALSJKy6sEAwvE0ANw', 'As真的苏云金芽孢杆菌');
// Scripts/As真的苏云金芽孢杆菌.js
...
cc.Class({
    ...
    update: function update(dt) {
        if (this.node.x <= 240 && this.node.x >= -250 && this.node.y <= 180 && this.node.y >= -220 && this.judge == 1) {
